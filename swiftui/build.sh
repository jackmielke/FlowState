#!/bin/bash
# Assembles a real FlowState.app bundle. A bare SPM binary is NOT an app bundle
...
BIN="$(swift build -c "$CONFIG" --show-bin-path)/FlowState"

echo "==> assembling $APP"
rm -rf "$APP"
mkdir -p "$APP/Contents/MacOS" "$APP/Contents/Resources"
cp "$BIN" "$APP/Contents/MacOS/FlowState"
