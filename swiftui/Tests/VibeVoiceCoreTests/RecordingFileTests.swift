...
final class RecordingFileTests: XCTestCase {
    ...
    private let folder = URL(fileURLWithPath: "/Users/x/Library/Application Support/VibeVoice/Recordings",
                             isDirectory: true)
    ...
    func test_theFolderIsShownRelativeToHome() {
        XCTAssertEqual(file().folderLabel(home: "/Users/x"),
                       "~/Library/Application Support/VibeVoice/Recordings")
    }
    ...
    func test_aPathOutsideHomeIsShownWhole() {
        ...
        XCTAssertEqual(file().folderLabel(home: "/Users/xavier"),
                       "/Users/x/Library/Application Support/VibeVoice/Recordings")
    }
