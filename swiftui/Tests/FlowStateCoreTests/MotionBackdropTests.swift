...
final class MotionBackdropTests: XCTestCase {
    ...
    private let user = URL(fileURLWithPath: "/Users/x/Library/Application Support/FlowState/Motion",
                           isDirectory: true)
    private let bundled = URL(fileURLWithPath: "/Applications/FlowState.app/Contents/Resources/Motion",
                              isDirectory: true)
